...
import TechnologyCardComponent from '@/components/technologies/TechnologyCardComponent.vue'
    ...
    <div>
      ...
      <div class="grid gap-16">
        ...
        >
          ...
          <div
            class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-3 gap-6 justify-center"
          >
